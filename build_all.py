...
from build_db import run, DEFAULTS
...
uthman16['font_url'] = 'https://raw.githubusercontent.com/tarekeldeeb/quran-madina-html-no-images/main/assets/fonts/UthmanTN_v2-0.woff2'
...
if __name__ == '__main__':
    ...
    with Pool(4) as p:
      r = list(tqdm(p.imap(run, list(map(lambda x: Namespace(**x) ,cfgs))), total=len(cfgs)))
